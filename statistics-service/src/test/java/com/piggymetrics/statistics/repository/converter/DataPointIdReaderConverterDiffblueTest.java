...
@ContextConfiguration(classes = {DataPointIdReaderConverter.class})
@RunWith(SpringJUnit4ClassRunner.class)
public class DataPointIdReaderConverterDiffblueTest {
    @Autowired
    private DataPointIdReaderConverter dataPointIdReaderConverter;

    /**
     * Test {@link DataPointIdReaderConverter#convert(DBObject)} with
     * {@code DBObject}.
     * <p>
     * Method under test: {@link DataPointIdReaderConverter#convert(DBObject)}
     */
    @Test
    @Ignore("TODO: Complete this test")
    public void testConvertWithDBObject() {
        ...
        // Arrange and Act
        dataPointIdReaderConverter.convert(new BasicDBList());
    }
}
