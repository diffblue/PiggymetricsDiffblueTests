...
public class ResourceServerConfigDiffblueTest {
  ...
  public void testClientCredentialsRestTemplate() {
    ...
    assertTrue(objectMapper.getSerializerProvider().getDefaultNullValueSerializer() instanceof NullSerializer);
    assertNull(objectMapper.getSerializationConfig().getActiveView());
